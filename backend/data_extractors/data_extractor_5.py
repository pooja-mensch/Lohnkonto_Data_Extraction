...
class DataExtractor5(DataExtractor):
    ...
    def __visitor(self, text: str, um, tm, font_dict, font_size):
        ...
        if (text == "Lohnsteuer" or text == "Sozialversicherung") and font_size == 9.35017:
        ...
        if self.__dataType == "Lohnsteuer" and font_size == 9.35017:
        ...
        if self.__dataType == "Sozialversicherung" and font_size == 9.35017:
    ...
    def process_page(self, page: PageObject, _start_page: bool):
        self.__dataType = ""
        self.__expectData = False
        visit_page(page, self.__visitor)
